function [net, info] = medicine(varargin)
...
opts.expDir = fullfile(vl_rootnn, 'data', ['GSE39582seriesmatrix-beforpca' sfx]) ;
[opts, varargin] = vl_argparse(opts, varargin) ;
...
if isempty(opts.network)
  net = medicine_init('batchNormalization', opts.batchNormalization, ...
...
data = single(reshape(cat(2, x1, x2),200,200,1,[]));
